...
@section('content')
    ...
    <!-- 
        ...
        =============================================
    -->
    <header class="bg-emerald-900 text-white py-20 md:py-26 shadow-2xl">
    ...
    <div class="bg-linear-to-r from-transparent via-zinc-400 to-transparent h-[3px] w-full"></div>
    <!-- 
        =============================================
    ...
    <!-- <section class="py-20 bg-emerald-600">
        <div class="max-w-4xl mx-auto px-6 lg:px-8 text-center">
            ...
            <p class="text-xl text-emerald-100 mb-10">
                Coba sekarang dan ubah imajinasi Anda menjadi kenyataan digital.
            </p>
            {{-- Karena hanya ada 2 fitur, tautan ini diarahkan ke Prompt to Video --}}
            <a href="{{ url('/generate') }}" 
                class="inline-block px-12 py-4 text-xl font-bold rounded-full shadow-2xl transition duration-300 transform bg-white text-emerald-700 hover:bg-gray-100 hover:scale-[1.05] focus:outline-none focus:ring-4 focus:ring-white focus:ring-opacity-50">
                Mulai Berkreasi Sekarang &rarr;
            </a>
        </div>
    </section> -->
    ...
    <!-- 
        ...
        =============================================
    -->
    <footer class="bg-gray-900 pt-10 pb-6 w-full text-center">
        <p class="text-sm text-gray-400">&copy; 2025 Budaya Loka AI. All rights reserved.</p>
    </footer>
